...
export default function RotatingEarth({ width = 800, height = 600, className = "" }: RotatingEarthProps) {
  ...
  useEffect(() => {
    ...
    const generateDotsInPolygon = (feature: any, dotSpacing = 20) => {
      ...
      const stepSize = dotSpacing * 0.12 // Larger step for fewer dots = faster generation
    ...
    const render = () => {
      ...
      if (landFeatures) {
        // Draw graticule - OPEF green theme
        ...
        // Draw halftone dots - OPEF green theme
        allDots.forEach((dot) => {
          ...
          if (
            ...
            context.fillStyle = "#97B34D" // OPEF olive color
  ...
  return (
    <div className={`relative ${className}`}>
      <canvas
        ref={canvasRef}
        className="w-full h-auto bg-background dark"
