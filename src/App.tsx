    ...
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
        <nav className="flex items-start justify-between mb-32 pt-8">
          ...
          <button className="px-6 py-2 border border-white/20 hover:bg-white hover:text-black transition-all duration-300 font-mono text-sm">
            BETA
          </button>
        </nav>
        ...
        <section className="mb-48">
          <div className="border border-white/20 p-12 md:p-16">
            <Square className="w-12 h-12 mb-12 text-white/40" strokeWidth={1} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12 border-t border-white/20">
              <div className="space-y-4">
                <div className="text-xs font-mono text-white/40">01</div>
                <h3 className="text-xl font-bold">Accelerated reviews</h3>
                <p className="text-sm font-light text-white/60">AI-assisted drafting and cross-agency analysis</p>
              </div>
              <div className="space-y-4">
                <div className="text-xs font-mono text-white/40">02</div>
                <h3 className="text-xl font-bold">Transparent reasoning</h3>
                <p className="text-sm font-light text-white/60">Every output linked to statute and precedent</p>
              </div>
              <div className="space-y-4">
                <div className="text-xs font-mono text-white/40">03</div>
                <h3 className="text-xl font-bold">Human-centered oversight</h3>
                <p className="text-sm font-light text-white/60">Experts remain in the loop as interpreters, not clerks</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-48">
          <div className="border-t border-white/20 pt-16">
            <p className="text-sm font-mono text-white/40 uppercase tracking-wider mb-12">Who It's For</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="space-y-8">
                <div className="border-l-4 border-white pl-6 py-2">
                  <h3 className="text-xl font-bold mb-2">Consulting firms</h3>
                  <p className="text-sm font-light text-white/70">Modernizing environmental reviews with explainable AI</p>
                </div>
                <div className="border-l-4 border-white/30 pl-6 py-2">
                  <h3 className="text-xl font-bold mb-2">Agencies</h3>
                  <p className="text-sm font-light text-white/70">Seeking compliance clarity and institutional memory</p>
                </div>
              </div>
              <div className="space-y-8">
                <div className="border-l-4 border-white/30 pl-6 py-2">
                  <h3 className="text-xl font-bold mb-2">Corporate sustainability teams</h3>
                  <p className="text-sm font-light text-white/70">Managing environmental permits, ESG reporting, or audit trails</p>
                </div>
                <div className="border-l-4 border-white/30 pl-6 py-2">
                  <h3 className="text-xl font-bold mb-2">Researchers & universities</h3>
                  <p className="text-sm font-light text-white/70">Exploring the intersection of AI governance, law, and society</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mb-48">
          <div className="bg-white text-black p-12 md:p-24">
            <h2 className="text-4xl md:text-6xl font-bold mb-16 tracking-tight">How It Works</h2>
            <div className="space-y-12">
              <div className="flex gap-8 items-start">
                <div className="text-6xl font-bold text-black/10 flex-shrink-0">01</div>
                <div>
              ...
              <div className="flex gap-8 items-start">
                <div className="text-6xl font-bold text-black/10 flex-shrink-0">02</div>
                <div>
              ...
              <div className="flex gap-8 items-start">
                <div className="text-6xl font-bold text-black/10 flex-shrink-0">03</div>
                <div>
              ...
              <div className="flex gap-8 items-start">
                <div className="text-6xl font-bold text-black/10 flex-shrink-0">04</div>
                <div>
        ...
        <section className="mb-48">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
            ...
            <div className="md:col-span-5 flex items-center justify-center">
              <div className="w-64 h-64 border-2 border-white/20 flex items-center justify-center">
                <div className="w-48 h-48 border border-white/40 flex items-center justify-center">
                  <div className="w-32 h-32 border border-white/60 flex items-center justify-center">
            ...
            {!submitted ? (
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <button
                    type="submit"
                    className="group bg-white text-black px-12 py-4 font-bold hover:bg-black hover:text-white border-2 border-white transition-all duration-300 flex items-center justify-center gap-3 text-lg"
                  >
                    JOIN
        ...
        <footer className="border-t border-white/20 pt-16 pb-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            <div className="space-y-4">
              ...
              <p className="text-sm font-light text-white/60 max-w-md">
